...
public class VeterinarioServiceITest {
    ...
    public void buscaVeterinariosComParteNome() {
        ...
        veterinario1.setNome("Gabriel da Mota Rodrigues");
        veterinario2.setNome("Gaio Brabo Rodrigues");
        ...
        List<Veterinario> respostaObtida = service.buscaVeterinariosComParteNome("Rodrigues");
    ...
    void deveLancarExcecaoAoApagarIdNaoExistente() {
        ...
        assertEquals("Veterinário com ID 9999 não foi encontrado no banco de dados. Operação de exclusão cancelada.",
                e.getMessage());
